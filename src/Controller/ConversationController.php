...
final class ConversationController extends AbstractController
{
    ...
    public function open(Conversation $conversation, Request $request, EntityManagerInterface $manager, HubInterface $hub, MercureJwtGenerator $jwtGenerator): Response
    {
        if(!$this->getUser()){return $this->redirectToRoute('app_login');}
